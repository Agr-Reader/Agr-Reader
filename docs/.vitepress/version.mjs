...
export const versionName = '1.18.3'

export const versionCode = 101018003

export const changelog = `• 新增针对订阅、群组和信息源的 AI 未读内容摘要，包含关键要点、主题、推荐阅读及来源引用
...
export const apkUrl = `https://resource.agrreader.com/f/d/DwI2/${apkFileKey}`
