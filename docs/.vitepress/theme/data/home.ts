...
export const homeData: Record<'root' | 'zh', HomeData> = {
  root: {
    ...
    screenshots: [
      { src: '/screenshots/gallery-iphone.webp', alt: 'Agr Reader on iPhone - AI-powered reading experience', caption: 'Agr Reader on iPhone - AI-powered reading experience' },
      { src: '/screenshots/gallery-android.webp', alt: 'Agr Reader on Android - full article with clean typography', caption: 'Agr Reader on Android - full article with clean typography' },
      { src: '/screenshots/gallery-ipad.webp', alt: 'Agr Reader on iPad - Comprehensive feed management features', caption: 'Agr Reader on iPad - Comprehensive feed management features' },
      { src: '/screenshots/gallery-macos.webp', alt: 'Agr Reader on macOS - two-column layout with list and article', caption: 'Agr Reader on macOS - two-column layout with list and article' },
