...
hero:
  ...
  actions:
    - theme: download
      ...
      iconHtml: |
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512"><!--!Font Awesome Free v7.1.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2026 Fonticons, Inc.--><path d="M293.6 234.3L72.9 13 353.7 174.2 293.6 234.3zM15.3 0C2.3 6.8-6.4 19.2-6.4 35.3l0 441.3c0 16.1 8.7 28.5 21.7 35.3L271.9 255.9 15.3 0zM440.5 225.6l-58.9-34.1-65.7 64.5 65.7 64.5 60.1-34.1c18-14.3 18-46.5-1.2-60.8zM72.9 499L353.7 337.8 293.6 277.7 72.9 499z"/></svg>
    - theme: download
      text: Windows
      subtitle: Available on
    ...
    - theme: download
      text: Linux
      subtitle: Available on
      link: https://github.com/Agr-Reader/Agr-Reader/releases/download/1.13.0/agr-reader_1.13.0_amd64.deb
      iconHtml: |
